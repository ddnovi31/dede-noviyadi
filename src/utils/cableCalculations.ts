...
import { NYCY_DATA, NYCYData } from './nycyData';
import { ABCData, ABCMessengerData, NFA2X_DATA, NFA2XT_DATA, getWeightAdditionFactor } from './abcData';
import { AACData, AAACSData, AAC_DATA, AAACS_DATA, AAC_SIZES, AAACS_SIZES } from './aacData';
import { NYA_NYAFData, NYA_NYAF_DATA } from './nyaData';
import {
  ...
  CURRENT_CAPACITY_AIR_CU,
  CURRENT_CAPACITY_AIR_CU_MV,
  CURRENT_CAPACITY_GROUND_CU,
  CURRENT_CAPACITY_GROUND_CU_MV,
  CURRENT_CAPACITY_AIR_AL,
  CURRENT_CAPACITY_AIR_AL_MV,
  CURRENT_CAPACITY_GROUND_AL,
  CURRENT_CAPACITY_GROUND_AL_MV,
  INSTRUMENT_FACTORS,
} from './conductorData';
import {
  CABLE_DATA,
